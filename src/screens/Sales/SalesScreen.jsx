...
const SalesScreen = ({ navigation }) => {
  ...
  useEffect(() => {
    ...
    if (searchQuery) {
      ...
      result = result.filter(item => {
        ...
        // Check Buyer Name
        if (item.buyerName && item.buyerName.toLowerCase().includes(lowerQuery))
          return true;

        // Check Items & Barcodes
    ...
    if (selectedFilter !== 'All') {
      ...
      result = result.filter(item => {
        ...
        if (selectedFilter === 'Pending')
          return item.paymentMethod === 'unpaid';
  ...
  const renderItem = ({ item }) => {
    ...
    const normalizedMethod = (
      typeof method === 'string' ? method : method?.paymentMethod || ''
    ).toLowerCase();
        ...
        <View style={styles.cardContent}>
          ...
          <View style={styles.rightCol}>
            ...
            <View style={[styles.paymentBadge, paymentStyle]}>
              <Text style={[styles.paymentText, paymentTextStyle]}>
                {paymentLabel}
              </Text>
            </View>
